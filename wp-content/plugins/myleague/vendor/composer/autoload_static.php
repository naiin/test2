...
class ComposerStaticInit924535d982404008762e4ff11847c194
{
    ...
    public static $classMap = array (
        'BookmakerTest' => __DIR__ . '/../..' . '/tests/Requests/BookmakerTest.php',
        'CommentaryTest' => __DIR__ . '/../..' . '/tests/Requests/CommentaryTest.php',
        'ContinentsTest' => __DIR__ . '/../..' . '/tests/Requests/ContinentsTest.php',
        'CountriesTest' => __DIR__ . '/../..' . '/tests/Requests/CountriesTest.php',
        'File_Iterator' => __DIR__ . '/..' . '/phpunit/php-file-iterator/src/Iterator.php',
        'File_Iterator_Facade' => __DIR__ . '/..' . '/phpunit/php-file-iterator/src/Facade.php',
        'File_Iterator_Factory' => __DIR__ . '/..' . '/phpunit/php-file-iterator/src/Factory.php',
        'FixtureTest' => __DIR__ . '/../..' . '/tests/Requests/FixtureTest.php',
        'Head2HeadTest' => __DIR__ . '/../..' . '/tests/Requests/Head2HeadTest.php',
        'LeagueTest' => __DIR__ . '/../..' . '/tests/Requests/LeagueTest.php',
        'LiveScoreTest' => __DIR__ . '/../..' . '/tests/Requests/LiveScoreTest.php',
        'OddsTest' => __DIR__ . '/../..' . '/tests/Requests/OddsTest.php',
        ...
        'PlayerTest' => __DIR__ . '/../..' . '/tests/Requests/PlayerTest.php',
        'RoundTest' => __DIR__ . '/../..' . '/tests/Requests/RoundTest.php',
        'SeasonTest' => __DIR__ . '/../..' . '/tests/Requests/SeasonTest.php',
        ...
        'SetupTest' => __DIR__ . '/../..' . '/tests/SetupTest.php',
        'StandingsTest' => __DIR__ . '/../..' . '/tests/Requests/StandingsTest.php',
        'TVStationTest' => __DIR__ . '/../..' . '/tests/Requests/TVStationTest.php',
        'TeamTest' => __DIR__ . '/../..' . '/tests/Requests/TeamTest.php',
        'TestCase' => __DIR__ . '/../..' . '/tests/TestCase.php',
        'Text_Template' => __DIR__ . '/..' . '/phpunit/php-text-template/src/Template.php',
        'TopScorerTest' => __DIR__ . '/../..' . '/tests/Requests/TopScorerTest.php',
        'VenueTest' => __DIR__ . '/../..' . '/tests/Requests/VenueTest.php',
        'VideoTest' => __DIR__ . '/../..' . '/tests/Requests/VideoTest.php',
    );

    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInit924535d982404008762e4ff11847c194::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInit924535d982404008762e4ff11847c194::$prefixDirsPsr4;
            $loader->prefixesPsr0 = ComposerStaticInit924535d982404008762e4ff11847c194::$prefixesPsr0;
            $loader->classMap = ComposerStaticInit924535d982404008762e4ff11847c194::$classMap;
